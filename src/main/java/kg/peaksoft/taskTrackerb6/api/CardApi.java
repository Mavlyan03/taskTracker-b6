...
public class CardApi {
    ...
    @PostMapping
    public CardResponse saveCard(@RequestBody CardRequest1 cardRequest1) {
    ...
    @PutMapping
    public CardResponse updateCardTitle(@RequestBody CardRequest1 cardRequest1) {
    ...
    @GetMapping("cards/{id}")
    public List<CardResponse> getAllCardsByLineId(@PathVariable Long id) {
