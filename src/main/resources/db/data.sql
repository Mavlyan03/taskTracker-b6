...
insert into boards(id, title, photo_link, is_archive, is_favorite, background, creator_id, workspace_id)
values (1, 'First Board', 'board_photo', false, false, 'background_image', 1, 1);
